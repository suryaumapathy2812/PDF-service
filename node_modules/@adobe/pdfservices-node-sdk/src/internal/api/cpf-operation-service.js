...
class CpfOperationService {
	...
	perform(context, operationMessage) {
		let cpfMessage = this.getCPFMessage(operationMessage),
			...
			contentAnalyzerRequests = new CpfContentAnalyzerRequests(engine,cpfMessage.inputDocuments,cpfMessage.params,cpfMessage.outputDocument, cpfMessage.extractOutputInfo),
